...
export default function MvpTable() {
    ...
    const wrapperClass = `fixed top-[32rem] -translate-y-1/2  inset-0 flex flex-col items-center justify-center transition-all duration-700 ease-in-out 
        ...
        <div className={wrapperClass}>
            <div className="flex flex-col items-start justify-center w-[70rem] px-4 mb-[1rem]">
                <div className="flex flex-col items-start relative" >
                    ...
                    <h1 className="table-title text-nowrap whitespace-nowrap">
                        <span>
                            MVP GERAL TOP 20
                        </span>
                    </h1>
            ...
            <div className="flex items-center justify-center relative gap-[7rem] origin-bottom w-[70rem]">
                <div className="flex items-center justify-center gap-[1.3rem]">
                    <div className="w-full h-[44.5rem]">
